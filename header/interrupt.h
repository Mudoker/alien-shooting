...
// Interrupt controller for RPI3: Section 7.5 of BCM2835 ARM Peripherals (Page 112)
#define INTERRUPT_BASE MMIO_BASE + 0xB000
#define INTERRUPT_IRQ_BASIC_PENDING (*(volatile unsigned int *)(INTERRUPT_BASE + 0x200))
#define INTERRUPT_IRQ_PENDING_1 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x204))
#define INTERRUPT_IRQ_PENDING_2 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x208))
#define INTERRUPT_FIQ_CONTROL (*(volatile unsigned int *)(INTERRUPT_BASE + 0x20C))
#define INTERRUPT_ENABLE_IRQS_1 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x210))
#define INTERRUPT_ENABLE_IRQS_2 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x214))
#define INTERRUPT_ENABLE_BASIC_IRQS (*(volatile unsigned int *)(INTERRUPT_BASE + 0x218))
#define INTERRUPT_DISABLE_IRQS_1 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x21C))
#define INTERRUPT_DISABLE_IRQS_2 (*(volatile unsigned int *)(INTERRUPT_BASE + 0x220))
#define INTERRUPT_DISABLE_BASIC_IRQS (*(volatile unsigned int *)(INTERRUPT_BASE + 0x224))

// Interrupt controller for RPI4: Section 6.5.3 of BCM2711 ARM Peripherals (Page 100-102)
